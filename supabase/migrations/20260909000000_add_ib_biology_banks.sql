-- Add IB Biology HL/SL and the Biology subject pair.
-- add biology products and bank allowlists
begin;
...
alter table public.products add constraint products_known_id check (id in (
  ...
  'bundle_igcse', 'bundle_ib_aa', 'bundle_ib_ai', 'bundle_ib_chemistry', 'bundle_ib_physics', 'bundle_ib_biology', 'bundle_all'
));
...
alter table public.saved_questions add constraint saved_questions_bank
  check (bank_slug in ('igcse', 'igcse-additional', 'ib-hl', 'ib-sl', 'ib-ai-hl', 'ib-ai-sl', 'ib-chemistry-hl', 'ib-chemistry-sl', 'ib-physics-hl', 'ib-physics-sl', 'ib-biology-hl', 'ib-biology-sl'));
...
insert into public.products (id, name, active) values
  ('bank_ib_biology_hl', 'IB Biology HL', true),
  ('bank_ib_biology_sl', 'IB Biology SL', true),
  ('bundle_ib_biology', 'IB Biology pair', true)
