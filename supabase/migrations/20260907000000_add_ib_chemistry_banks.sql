-- Add IB Chemistry HL/SL and the Chemistry subject pair.
...
alter table public.products add constraint products_known_id check (id in (
  ...
  'bundle_igcse', 'bundle_ib_aa', 'bundle_ib_ai', 'bundle_ib_chemistry', 'bundle_all'
));
...
alter table public.saved_questions add constraint saved_questions_bank
  check (bank_slug in ('igcse', 'igcse-additional', 'ib-hl', 'ib-sl', 'ib-ai-hl', 'ib-ai-sl', 'ib-chemistry-hl', 'ib-chemistry-sl'));
...
insert into public.products (id, name, active) values
  ('bank_ib_chemistry_hl', 'IB Chemistry HL', true),
  ('bank_ib_chemistry_sl', 'IB Chemistry SL', true),
  ('bundle_ib_chemistry', 'IB Chemistry pair', true)
