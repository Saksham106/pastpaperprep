...
export default async function WorksheetsPage() {
  ...
  return <main className="worksheet-library-page shell"><Link className="worksheet-library-back" href="/dashboard" aria-label="Back to dashboard">← <span>Back to dashboard</span></Link><header className="worksheet-library-header"><p className="eyebrow">Your work</p><h1>My worksheets</h1><p>Pick up where you left off, or edit a saved question set.</p></header><WorksheetList /></main>;
}
