...
describe("new-bank classification quality", () => {
  it.each(["ib-sl", "ib-ai-hl", "ib-ai-sl"] as const)("keeps every %s subtopic non-empty and owned by a classified topic", (bankSlug) => {
  ...
  it.each(["ib-sl", "ib-ai-hl", "ib-ai-sl"] as const)("classifies duplicate %s evidence consistently", (bankSlug) => {
    const questions = loadBankQuestions(bankSlug);
