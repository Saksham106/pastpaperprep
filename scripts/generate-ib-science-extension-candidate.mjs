...
for (const [key, s] of Object.entries(sources)) {
  ...
  const receiptSha256 = assertPinnedReceipt(key, receiptBytes);
  ...
  const runtimeSeal = { schemaVersion: "ib-science-extension-candidate.v1", sourceCommit: s.commit, receiptSha256, subject: s.subject, extensionRows: extension.length, years: [2016,2017,2018,2019], levelCounts: s.split };
